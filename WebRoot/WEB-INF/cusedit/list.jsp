	    ...
	    function timeQuery(){
	    	if (document.getElementById("startTime").value==""||document.getElementById("endTime")=="") {
		    	...
		    	if (parseInt(startTime)>parseInt(endTime)) {
					...
					window.open("/want/ProcessedAction.action?startTime="+startTime+
			    			"&endTime="+endTime);
				}
			}
		...
		function timeDownload(){
			if (document.getElementById("startTime").value==""||document.getElementById("endTime").value=="") {
		    	...
		    	if (parseInt(startTime)>parseInt(endTime)) {
					...
					window.open("/want/DownloadAction.action?startTime="+startTime+
			    			"&endTime="+endTime);
				}
			}
	    }
  							...
  							<s:iterator value="proList" id="proDesc" status="S">
  								<li class="option_b" >
									...
									<input id="checkradio1" class="form-checkbox" type="radio"
										name="cusDesc.id" value="<s:property value="#proDesc.id"/>" onclick="radioChange1()"/>

  			...
  			<div id="body_wrapper">
  				<form action="CusEditAction" method="post"  >
  					<div id="op">
  									...
  									<div>
  										...
  										<s:if test="#proDesc.description=='其他'">
  												...
  												<s:else>
  													...
  													<input type="radio" name="cusDetail.id"  value="<s:property value="#proDetail.id"/>" />
  													<input type="text" name="cusDetail.detail" value="<s:property value="#proDetail.detail"/>" />
  													</s:iterator>
  												</s:else>
  										</div>
  									</div>
  						...
  						<s:iterator value = "updateList" id = "updateDetail">
  							<input type="text" name="cusDetail.detail" value="<s:property value="#updateDetail.detail"/>" />
  							<input type="hidden" name="cusDetail.id" value="<s:property value="#updateDetail.id"/>"/>
  							<input type="hidden" name="cusDetail.cusDesc.id" value="<s:property value="#updateDetail.cusDesc.id"/>"/>
  						</s:iterator>
  						<s:iterator value = "updateDesc" id = "updateDesc">
  							<input type="text" name="cusDesc.description" value="<s:property value="#updateDesc.description"/>" />
  							<input type="hidden" name="cusDesc.id" value="<s:property value="#updateDesc.id"/>"/>
  						</s:iterator>

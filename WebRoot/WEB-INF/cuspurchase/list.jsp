  					...
  					<div id="op">
  						...
  						<ol id="option">
  							<table class="hovertable" >
  									<thead><tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';"><td>快递单号</td><td>收件人</td><td>手机号</td><td>地址</td><td>平台订单编号</td><td>平台</td><td>店铺名</td><td>订单日期</td><td>售后问题</td><td>问题详细</td><td>客服操作意见</td><td>处理人</td><td>备注</td><td>网上订单编号</td><td>发货方式</td><td></td><td></td></tr></thead>
  									<s:iterator value="purchaseList" id="purchaseList" >
  										<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
											...
											<td class="opa"><input  class="btn" type="Submit" value="详情" onclick="getRowID(<s:property value="#purchaseList.id"/>)" /></td>
											<s:if test="#purchaseList.backresult == null"><td style="color:red">（未处理）</td></s:if><s:else><td style="color:green">（已处理）</td></s:else>
  										</tr>
  									</s:iterator>
  								</table>
  						</ol>

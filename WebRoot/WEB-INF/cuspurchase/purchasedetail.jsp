  							...
  							<table class="hovertable" >
  									...
  									<s:iterator value="purchaseList" id="purchaseList" >
  										<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
											<td><s:property value="#purchaseList.waybill"/></td>
											<td><s:property value="#purchaseList.linkman"/></td>
											<td><s:property value="#purchaseList.handset"/></td>
											<td><s:property value="#purchaseList.recaddr"/></td>
											<td><s:property value="#purchaseList.relid"/></td>
											<td><s:property value="#purchaseList.sysname"/></td>
											<td><s:property value="#purchaseList.shopname"/></td>
											<td><s:property value="#purchaseList.orderdate"/></td>
											<td><s:property value="#purchaseList.cusdesc"/></td>
											<td><s:property value="#purchaseList.cusdetail"/></td>
											<td><s:property value="#purchaseList.operateopinion"/></td>
											<td><s:property value="#purchaseList.operateman"/></td>
											<td><s:property value="#purchaseList.operateremark"/></td>
											<td><s:property value="#purchaseList.ecid"/></td>
											<td><s:property value="#purchaseList.goodsendtype"/></td>
  										</tr>
										<input type="hidden" name="cusCollect.waybill"  value="<s:property value="#purchaseList.waybill"/>"/>
										<input type="hidden" name="cusCollect.linkman"  value="<s:property value="#purchaseList.linkman"/>"/>
										<input type="hidden" name="cusCollect.handset"  value="<s:property value="#purchaseList.handset"/>"/>
										<input type="hidden" name="cusCollect.recaddr"  value="<s:property value="#purchaseList.recaddr"/>"/>
										<input type="hidden" name="cusCollect.relid"  value="<s:property value="#purchaseList.relid"/>"/>
										<input type="hidden" name="cusCollect.sysname"  value="<s:property value="#purchaseList.sysname"/>"/>
										<input type="hidden" name="cusCollect.shopname"  value="<s:property value="#purchaseList.shopname"/>"/>
										<input type="hidden" name="cusCollect.orderdate"  value="<s:property value="#purchaseList.orderdate"/>"/>
										<input type="hidden" name="cusCollect.cusdesc"  value="<s:property value="#purchaseList.cusdesc"/>"/>
										<input type="hidden" name="cusCollect.cusdetail"  value="<s:property value="#purchaseList.cusdetail"/>"/>
										<input type="hidden" name="cusCollect.operateopinion"  value="<s:property value="#purchaseList.operateopinion"/>"/>
										<input type="hidden" name="cusCollect.operateman"  value="<s:property value="#purchaseList.operateman"/>"/>
										<input type="hidden" name="cusCollect.operateremark"  value="<s:property value="#purchaseList.operateremark"/>"/>
										<input type="hidden" name="cusCollect.ecid"  value="<s:property value="#purchaseList.ecid"/>"/>
										<input type="hidden" name="cusCollect.goodsendtype"  value="<s:property value="#purchaseList.goodsendtype"/>"/>
										<input type="hidden" name="cusCollect.image"  value="<s:property value="#purchaseList.imgpur"/>"/>
  									</s:iterator>
  								</table>
  						</ol>
  						<ol id="option">
  							<img src ='<%=request.getContextPath()%>/<s:property value ="#purchaseList.imgpur" /> ' />
  						</ol>
  						<ol id="option">
  						<table class="hovertable" >

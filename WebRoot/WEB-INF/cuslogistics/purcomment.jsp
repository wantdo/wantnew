  					...
  					<div id="op">
  						...
  						<ol id="option">
  							<table class="hovertable" >
  									<thead><tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';"><td>订货日期</td><td>采购订单号</td><td>供应商名称</td><td>商品名称</td><td>条形码</td><td>货号</td><td>事物特性</td><td>快递公司</td><td>快递单号</td><td>到货时间</td><td>完好情况</td><td>处理意见</td><td></td></tr></thead>
  									<s:iterator value="orderList" id="orderList" >
  										<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
											...
											<td class="opa"><input  class="btn" type="Submit" value="退货" onclick="getRowID(<s:property value="#orderList.id"/>)" /></td>
						...
						<input type="hidden" name="variable" id="variable" value="returngoods" />
  					</div> 					
  					<div class="opa">

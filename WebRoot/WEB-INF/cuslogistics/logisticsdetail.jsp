...
<html>
  <head>
    ...
    <title>物流详情</title><%=request.getSession().getAttribute("username") %>，您好
  				...
  				<form action="CusBackstageAction" method="post" name = "form1">
  					<div id="op">
  						...
  						<ol id="option">
  							<table class="hovertable" >
  									...
  									<s:iterator value="logisticsList" id="logisticsList" >
										...
										<input type="hidden" name="cusCollect.handset"  value="<s:property value="#logisticsList.handset"/>"/>
										<input type="hidden" name="cusCollect.recaddr"  value="<s:property value="#logisticsList.recaddr"/>"/>
										<input type="hidden" name="cusCollect.relid"  value="<s:property value="#logisticsList.relid"/>"/>
  						...
  						<table class="hovertable" >
  							...
  							<input type="radio" name="cusLogistics.backresult"  value="换货" />换货
  						...
  						<input type="hidden" name="variable" id="variable" value="backresult" />
  					</div>
  				</form>
  			</div>
  		</div>

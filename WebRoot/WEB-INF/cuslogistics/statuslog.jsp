  			...
  			<div id="body_wrapper">
  				<form action="CusBackAction" method="post" name = "form1">
  					<div id="op">
  							...
  							<table class="hovertable" >
  									...
  									<s:iterator value="orderList" id="orderList" >
  										<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
											...
											<s:if test='#orderList.purresult == 201 && #orderList.status == "退货中"'><td class="opa"><input  class="btn" type="Submit" value="补货已收" onclick="getRowID(<s:property value="#orderList.id"/>)" /></td></s:if>
											<s:else><td></td></s:else>
  										</tr>
  									</s:iterator>
  								</table>
						...
						<input type="hidden" name="variable" id="variable" value="replacement" />
  					</div> 					
  					<div class="opa">

...
<html>
  <head>
    ...
    <title>店铺编辑</title><%=request.getSession().getAttribute("username") %>，您好
  ...
  <body >
  		<div id="main">
  			...
  			<div id="body_wrapper">
  				<form action="CusShopsAction" method="post"  >
  					<div id="op">
  						<div class="noavatar">
  							<h3>店铺编辑</h3>
  						</div>
  						<table class="hovertable" >
  						<thead><tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';"><td>平台</td><td>ERP店铺名</td><td>本地店铺名</td><td>店铺负责人</td><td>店铺邮箱</td><td>店铺编号</td><td>所属行业</td></tr></thead>
  							<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
		  						<s:iterator value = "updateList" id = "updateList">
		  							<td><input type="text" value="<s:property value="#updateList[1]"/>" readonly="readonly"/></td>
		  							<td><input type="text" value="<s:property value="#updateList[2]"/>" readonly="readonly"/></td>
		  							<td><input type="text" name="cusShops.shopname" value="<s:property value="#updateList[3]"/>" /></td>
		  							<td><input type="text" name="cusShops.shopmanager" value="<s:property value="#updateList[4]"/>" /></td>
		  							<td><input type="text" name="cusShops.shopemail" value="<s:property value="#updateList[5]"/>" /></td>
		  							<td><input type="text" name="cusShops.shopno" value="<s:property value="#updateList[6]"/>" /></td>
		  							<td><input type="text" name="cusShops.shopindustry" value="<s:property value="#updateList[7]"/>" /></td>
		  							<input type="hidden" name="cusShops.wspshopid" value="<s:property value="#updateList[8]"/>" />
		  							<input type="hidden" name="cusShops.id" value="<s:property value="#updateList[9]"/>"/>
		  						</s:iterator>
	  						</tr>
  						</table>
  						<div class="opa">

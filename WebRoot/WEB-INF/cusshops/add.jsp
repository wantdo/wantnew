  							...
  							<table class="hovertable" >
  								...
  								<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
	  								<s:iterator value = "updateList" id = "updateList">
			  							...
			  							<td><input type="text" name="cusShops.shopname"  /></td>
			  							<td><input type="text" name="cusShops.shopmanager"  /></td>
			  							<td><input type="text" name="cusShops.shopemail"  /></td>
			  							<td><input type="text" name="cusShops.shopno"  /></td>
			  							<td><input type="text" name="cusShops.shopindustry"  /></td>
			  							<input type="hidden" name="cusShops.wspshopid" value="<s:property value="#updateList[0]"/>" />
			  						</s:iterator>
		  						</tr>
  							</table>
  						</ol>

...
<html>
  ...
  <body >
  		<div id="main">
  			...
  			<div id="body_wrapper">
  				<form action="CusShopsAction" method="post" name = "form1">
  					<div id="op">
  						<div class="noavatar">
  							<h3>店铺编辑</h3>
  						</div>
  						<ol id="option">
  								<%-- <table class="hovertable" width="550" align="left">
  									<thead><tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';"><td></td><td>wantdo店铺名</td></tr></thead>
  									<s:iterator value="cusList" id="cusList" >
  										<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
											<td><input id="checkradio" checked="checked" class="form-checkbox" type="radio" name="cusShops.id" value="<s:property value="#cusList.id"/>" /></td>
											<td><s:property value="#cusList.shopname"/></td>
  										</tr>
  									</s:iterator>
  								</table> --%>
  								<table class="hovertable" >
  									...
  									<s:iterator value="wspList" id="wspList" >
  										<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
											...
											<%-- <td><s:property value="#wspList[0]"/></td> --%>
											<td><s:property value="#wspList[1]"/></td>
											<td><s:property value="#wspList[2]"/></td>
											<td><s:property value="#wspList[3]"/></td>
											<td><s:property value="#wspList[4]"/></td>
											<td><s:property value="#wspList[5]"/></td>
											<td><s:property value="#wspList[6]"/></td>
											<td><s:property value="#wspList[7]"/></td>
  										</tr>
  									</s:iterator>
  								</table>
  						</ol>

...
import com.wantdo.dao.IWspOrdermstDAO;
import com.wantdo.domain.WspOrdermst;

/**
 	* A data access object (DAO) providing persistence and search support for WspOrdermst entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.wantdo.domain.WspOrdermst
  * @author MyEclipse Persistence Tools 
 */
public class WspOrdermstDAO extends HibernateDaoSupport implements IWspOrdermstDAO  {
	     private static final Logger log = LoggerFactory.getLogger(WspOrdermstDAO.class);
		//property constants
    ...
    public WspOrdermst findById( java.lang.String id) {
        ...
        try {
            WspOrdermst instance = (WspOrdermst) getHibernateTemplate()
                    .get("com.wantdo.domain.WspOrdermst", id);
            return instance;
        } catch (RuntimeException re) {
	...
	* @param relid
	* @return 
	* @see com.wantdo.dao.impl.IWspOrdermstDAO#findByRelid(java.lang.Object) 
	*/ 
	@Override
    ...
    public WspOrdermst merge(WspOrdermst detachedInstance) {
        ...
        try {
            WspOrdermst result = (WspOrdermst) getHibernateTemplate()
	...
	public static IWspOrdermstDAO getFromApplicationContext(ApplicationContext ctx) {

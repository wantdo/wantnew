...
/**
 	* A data access object (DAO) providing persistence and search support for EcEordermst entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.wantdo.domain.EcEordermst
  * @author MyEclipse Persistence Tools 
 */
public class EcEordermstDAO extends HibernateDaoSupport implements IEcEordermstDAO  {
	     private static final Logger log = LoggerFactory.getLogger(EcEordermstDAO.class);
		//property constants
	...
	public static final String DISTRIBUTEFLAG = "distributeflag";
	...
	* @see com.wantdo.dao.impl.IEcEordermstDAO#save(com.wantdo.domain.EcEordermst) 
	*/ 
    @Override
	...
	* @param id
	* @return 
	* @see com.wantdo.dao.impl.IEcEordermstDAO#findById(java.lang.String) 
	*/ 
    @Override
	public EcEordermst findById( java.lang.String id) {
        log.debug("getting EcEordermst instance with id: " + id);
        try {
            EcEordermst instance = (EcEordermst) getHibernateTemplate()
                    .get("com.wantdo.domain.EcEordermst", id);
            return instance;
        } catch (RuntimeException re) {
	...
	* @param map
	* @return 
	* @see com.wantdo.dao.impl.IWspOrdermstDAO#findByMap(java.util.Map) 
	*/ 
    @Override
	public List findByMap(Map<String, String> map){
    	List result=doQueryByAndOr(map, "and");
    	if (result.size()!=0) {
    		return result;
		}else {
			result=doQueryByAndOr(map, "or");
			return result;
		}
    	
    }
    
    public List doQueryByAndOr(Map<String, String> map,String link){
    	try {
    		...
    		for(Entry<String, String> entry:map.entrySet()){
    			if (sBuffer.indexOf("where")==-1) {
					...
					sBuffer.append(" ").append(link).append(" ");
				}
			...
			log.error("find by map failed",re);
			throw re;
		}
    }
    ...
    public List findByOrderid(Object orderid){
		try {
			String queryString="select wsp.skuname,wsp.strdisplay,ec.qty,wsp.itemno from " +
					"EcEorderdtl ec,WspItemspecification wsp where ec.id.orderid=? and ec.skuid=wsp.skuid";
	...
	/* (非 Javadoc) 
	* <p>Title: findByRelid</p> 
	* <p>Description: </p> 
	* @param relid
	* @return 
	* @see com.wantdo.dao.impl.IEcEordermstDAO#findByRelid(java.lang.Object) 
	*/ 
	@Override
	...
	public List findByDistributeflag(Object distributeflag
	) {
		return findByProperty(DISTRIBUTEFLAG, distributeflag
		);
	}
	
	public List findByOutofstockflag(Object outofstockflag
	) {
		return findByProperty(OUTOFSTOCKFLAG, outofstockflag
		);
	}
    ...
    public EcEordermst merge(EcEordermst detachedInstance) {
        ...
        try {
            EcEordermst result = (EcEordermst) getHibernateTemplate()
	...
	public static IEcEordermstDAO getFromApplicationContext(ApplicationContext ctx) {
